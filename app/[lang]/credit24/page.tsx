...
export async function generateMetadata({
  ...
  return {
    title: dict.creditors.credit24.title,
    description: dict.creditors.credit24.description,
    openGraph: {
      title: dict.creditors.credit24.title,
      description: dict.creditors.credit24.description,
      url: "/credit24",
...
export default async function Credit24Page({
  params,
}: {
  params: Promise<{ lang: string }>
}) {
  const { lang } = await params
  const dict = await getDictionary(lang)
  const creditor = dict.creditors.credit24
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <section aria-labelledby="credit24-info" className="my-12">
        <article>
          <Card className="overflow-hidden">
            <CardHeader className="bg-primary text-white">
              <CardTitle id="credit24-info" className="text-2xl">{creditor.name}</CardTitle>
      ...
      <section className="my-16" aria-labelledby="calculator-title">
        ...
        <LoanCalculator lang={lang} creditor="credit24" />
      </section>
      ...
      <section className="my-16" aria-labelledby="faq-title">
        ...
        <FaqSection lang={lang} category="credit24" />
      </section>
