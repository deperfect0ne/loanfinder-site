// app/[lang]/laenud/eraisikult/page.tsx
'use server'
...
export default async function PrivatePersonLoanPage({
  params,
}: {
  params: Promise<{ lang: string }>
}) {
